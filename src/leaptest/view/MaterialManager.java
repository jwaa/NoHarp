...
public class MaterialManager {
    ...
    public static Material normal, lifted, falling, target, gridnormal, ringrotate, over, creationblock, creationblockover, floor, leaphand;
    ...
    public static void init(AssetManager assetManager)
    {
        ...
        creationblockover = generateMaterial(assetManager, ColorRGBA.White);
        creationblockover.setTexture("DiffuseMap",assetManager.loadTexture("Textures/CubeTexCreateOver.png"));
